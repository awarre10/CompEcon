...
% Option: EUR/USD 3 month vanilla call (12/12/21) - Data from Bloomberg LP

tic
% Define parameters
r     = -0.0607;     % risk free interest rate
delta = 0;           % rate of dividend payments
kappa = 5;           % mean-reversion parameter on volatility 
m     = 0.004;       % long-run mean volatility
sigma = 0.28391;     % volatility of volatility
rho   = -0.1775;     % correlation between price and volatility
K     = 1.343;       % strike price
put   = 0;           % 0=call, 1=put
